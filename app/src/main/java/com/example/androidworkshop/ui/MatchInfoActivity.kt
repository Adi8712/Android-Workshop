...
import com.example.androidworkshop.databinding.ActivityMatchInfoBinding
...
class MatchInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val matchId = receivedIntent.getStringExtra("matchId")
...
//                    ImageList = it.data
                    ...
                    binding.team1score.text =
                        scoreCard.miniscore.matchScoreDetails.inningsScoreList[1].score.toString() + "/" + scoreCard.miniscore.matchScoreDetails.inningsScoreList[1].wickets.toString()
                    binding.team2score.text =
                        scoreCard.miniscore.matchScoreDetails.inningsScoreList[0].score.toString() + "/" + scoreCard.miniscore.matchScoreDetails.inningsScoreList[0].wickets.toString()
                    binding.team1over.text =
                        "(" + scoreCard.miniscore.matchScoreDetails.inningsScoreList[1].overs.toString() + ")"
                    binding.team2over.text =
                        "(" + scoreCard.miniscore.matchScoreDetails.inningsScoreList[0].overs.toString() + ")"
